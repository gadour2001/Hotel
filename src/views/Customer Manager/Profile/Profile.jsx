...
const Profile = () => {
  ...
  const idCustomerManager = localStorage.getItem('user')?JSON.parse(localStorage.getItem('user')).user.payload.user._id:null
  ...
  const EditPassword = () => {
    if(newPassword === confirmPassword){
      axiosApi.put(UPDATE_PASSWORD_URL , idCustomerManager , {newPassword : newPassword , oldPassword : oldPassword })
      .then(() => {
        setVisible(false)
        Swal.fire(
          'Updated!',
