...
const ProfileAdmin = React.lazy(() => import('./views/Admin/Profile/Profile'))

// Customer Manager
const DashboardCustomerManager = React.lazy(() => import('./views/Customer Manager/Dashboard/DashboardCustomerManager'))
const ProfileCustomerManager = React.lazy(() => import('./views/Customer Manager/Profile/Profile'))
...
const ProfileServiceManager = React.lazy(() => import('./views/Manager/Profile/Profile'))
...
const ItemPage = React.lazy(() => import('./views/Customer/ItemPage/ItemPage'))
const Cart = React.lazy(() => import('./views/Customer/Cart/cart'))
const History = React.lazy(() => import('./views/Customer/History/History'))
const Reservation = React.lazy(() => import('./views/Customer/Reservation/reservation'))
...
switch (role) {
  case 'client':
    routes = [
      ...
      { path: '/serviceCustomer/productCustomer/itemPage/:idService/:idProduct', name: 'ItemPage', element: ItemPage },
      { path: '/history', name: 'History', element: History },
      { path: '/reservation', name: 'Reservation', element: Reservation },
  ...
  case 'responsableClient':
    routes = [
      ...
      { path: '/profileCustomerManager', name: 'Profil', element: ProfileCustomerManager },
      { path: '/*', name: 'PageNotFound', element: PageNotFound },
    ]
    break;
  ...
  case 'responsableService':
    routes = [
      ...
      { path: '/profileServiceManager', name: 'Profil', element: ProfileServiceManager },
      { path: '/*', name: 'PageNotFound', element: PageNotFound },
    ]
    break;
  ...
  case 'admin':
    routes = [
      ...
      { path: '/profileAdmin', name: 'Profil', element: ProfileAdmin },
      { path: '/*', name: 'PageNotFound', element: PageNotFound },
    ]
    break;
}
